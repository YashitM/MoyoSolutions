# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-01-04 15:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_latitude', models.CharField(blank=True, db_column='source_latitude', max_length=100, null=True)),
                ('source_longitude', models.CharField(blank=True, db_column='source_longitude', max_length=100, null=True)),
                ('destination', models.CharField(blank=True, db_column='destination', max_length=100, null=True)),
                ('destination_latitude', models.CharField(blank=True, db_column='destination_latitude', max_length=100, null=True)),
                ('destination_longitude', models.CharField(blank=True, db_column='destination_longitude', max_length=100, null=True)),
