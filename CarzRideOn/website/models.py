...
class Rides(models.Model):
    ...
    source = models.CharField(max_length=200, blank=True, null=True, db_column='source')
    ...
    destination = models.CharField(max_length=200, blank=True, null=True, db_column='destination')
